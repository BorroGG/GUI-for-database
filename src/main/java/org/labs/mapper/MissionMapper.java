...
public interface MissionMapper {
    @Insert("insert into mission(missionid, name, description, begin_date, end_date, complete, author, executor, priorityid, customerid)" +
            "values(#{missionId}, #{name}, #{description}, #{beginDate}, #{endDate}), #{complete}, #{author}, #{executor}, #{priorityId}, #{customerId})")
    ...
    Mission selectMissionByNumber(Mission mission);
